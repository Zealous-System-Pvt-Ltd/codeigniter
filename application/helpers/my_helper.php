...
function success_message($content = '', $size = '14px') {
    if ($content != '') {
...
function error_message($content = '', $size = '14px') {
    if ($content != '') {
        return '<p class="box-msg">
...
function show_modal($content = '', $id = '', $data = '', $size = 'md') {
    $_ci = &get_instance();
...
function show_confirm_modal($id = '', $class = '', $title = 'Confirmation', $yes = 'Yes', $no = 'No') {
    $_ci = &get_instance();
    if ($id != '') {
