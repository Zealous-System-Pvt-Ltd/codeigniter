        ...
        <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
                ...
                <a href="<?php echo base_url(); ?>assets/#" class="dropdown-toggle" data-toggle="dropdown">
                    ...
                    <img src="<?php echo base_url(); ?>assets/img/<?php echo $userdata->profileimage; ?>" class="user-image" alt="User Image">
                    <!-- hidden-xs hides the username on small devices so only the image appears. -->
                    <span class="hidden-xs"><?php echo $userdata->firstname . ' ' . $userdata->lastname; ?></span>
                </a>
                <ul class="dropdown-menu">
                    ...
                    <li class="user-header">
                        ...
                        <p>
                            <?php echo $userdata->firstname . ' ' . $userdata->lastname; ?> - Web Developer
